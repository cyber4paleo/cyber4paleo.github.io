...
* <b>Description:</b> The R2R facility maintains a master catalog of field expeditions (oceanographic cruises) for the US academic research fleet, including those that collect seafloor samples for paleo studies.  Each cruise has a DOI, which is linked to related resources in SESAR, EarthChem, etc, as well as to ORCID iDs for investigators.  The entire R2R catalog is published as Linked Data.
